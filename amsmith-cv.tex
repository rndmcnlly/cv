...
\item 
    ...
    \begin{itemize}
        ...
        % * AAAI 2010: ludocore
        % * FDG 2010 PCG: variations forever
        % * FDG 2010 INT3: rolemodel
...
\item
    ...
    \begin{itemize}
        ...
        \item Coached undergraduate volunteers in their own cirriculum development efforts
    \end{itemize}
...
\begin{itemize}
  ...
  \item James Davis (Teaching Mentor and Graphics/Vision Research Adivsor from UCSC)
  ...
  \item Jeff Lindsay (Friend, Founder of SuperHappyDevHouse and HackerDojo (very significant fixures in current sillicon valley hacker culture), education/games/hacker/systems philosophy discussion cohort)
\end{itemize}
